...
const host = process.env.RENDER_URL ? `${process.env.RENDER_URL}` : 'http://localhost:3030';
//api.settings.host = 'http://localhost:3030';
api.settings.host = process.env.RENDER_URL ? `${process.env.RENDER_URL}` : 'http://localhost:3030';
